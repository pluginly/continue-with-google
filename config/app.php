...
use ContinueWithGoogle\App\Http\Middleware\EnsureIsUserAdmin;
use ContinueWithGoogle\App\Providers\MenuServiceProvider;
// use ContinueWithGoogle\Database\Migrations\TestMigration;
use ContinueWithGoogle\WpMVC\Helpers\Helpers;

return [
    /**
     * The version of the plugin.
     */
    'version'                     => Helpers::get_plugin_version( 'continue-with-google' ),
    ...
    'rest_api'                    => [
         ...
         */
        'namespace' => 'continue-with-google',
     ...
     */
    'migration_db_option_key'     => 'continue_with_google_migrations',
     ...
     */
    'rest_response_action_hook'   => 'continue-with-google_rest_response_action',
     ...
     */
    'rest_response_filter_hook'   => 'continue-with-google_rest_response_filter',
     ...
     */
    'rest_permission_filter_hook' => 'continue-with-google_rest_permission_filter',
];